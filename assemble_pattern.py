...
# done: jal zero, start  # Jump back to beginning for infinite loop
# Offset = 0 - (len(program) * 4) = -84
program.append(encode_j_type(OP_JAL, regs['zero'], to_twos_complement(-(len(program) * 4), 21)))
